...
require("./tasks");
const hardhat_preprocessor_1 = require("hardhat-preprocessor");
const accounts = {
...
const config = {
    ...
    preprocess: {
        eachLine: (0, hardhat_preprocessor_1.removeConsoleLog)((bre) => bre.network.name !== "hardhat" && bre.network.name !== "localhost"),
    },
    solidity: {
        compilers: [
            {
