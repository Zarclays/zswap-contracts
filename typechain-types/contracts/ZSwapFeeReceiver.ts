...
export interface ZSwapFeeReceiverInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "owner"
      | "renounceOwnership"
...
export interface ZSwapFeeReceiver extends BaseContract {
  connect(runner?: ContractRunner | null): ZSwapFeeReceiver;
  waitForDeployment(): Promise<this>;

  interface: ZSwapFeeReceiverInterface;
