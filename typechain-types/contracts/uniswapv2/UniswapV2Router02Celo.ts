...
export interface UniswapV2Router02CeloInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "WETH"
      | "addLiquidity"
...
export interface UniswapV2Router02Celo extends BaseContract {
  connect(runner?: ContractRunner | null): UniswapV2Router02Celo;
  waitForDeployment(): Promise<this>;

  interface: UniswapV2Router02CeloInterface;
