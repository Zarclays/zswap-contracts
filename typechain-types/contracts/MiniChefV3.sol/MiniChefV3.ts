...
export declare namespace MiniChefV3 {
...
export interface MiniChefV3Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "REWARD"
      | "acceptOwnership"
  ...
  encodeFunctionData(
    functionFragment: "massUpdateSelectedPools",
    values: [BigNumberish[]]
  ): string;
...
export interface MiniChefV3 extends BaseContract {
  connect(runner?: ContractRunner | null): MiniChefV3;
  waitForDeployment(): Promise<this>;

  interface: MiniChefV3Interface;
  ...
  massUpdateSelectedPools: TypedContractMethod<
    [pids: BigNumberish[]],
    [void],
    "nonpayable"
  >;
  ...
  updatePool: TypedContractMethod<
    [_pid: BigNumberish],
    [MiniChefV3.PoolInfoStructOutput],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "massUpdateSelectedPools"
