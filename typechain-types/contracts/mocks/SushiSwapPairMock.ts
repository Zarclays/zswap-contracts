...
export interface SushiSwapPairMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "MINIMUM_LIQUIDITY"
  ...
  encodeFunctionData(functionFragment: "pairMul", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "pairMul", data: BytesLike): Result;
...
export interface SushiSwapPairMock extends BaseContract {
  connect(runner?: ContractRunner | null): SushiSwapPairMock;
  ...
  pairMul: TypedContractMethod<[], [bigint], "view">;
