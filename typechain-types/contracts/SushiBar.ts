...
export interface SushiBarInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface SushiBar extends BaseContract {
  connect(runner?: ContractRunner | null): SushiBar;
  ...
  enter: TypedContractMethod<[_amount: BigNumberish], [void], "nonpayable">;
  ...
  leave: TypedContractMethod<[_share: BigNumberish], [void], "nonpayable">;
