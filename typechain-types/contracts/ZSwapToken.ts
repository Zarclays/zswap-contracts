...
export interface ZSwapTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "MINTER_ROLE"
...
export interface ZSwapToken extends BaseContract {
  connect(runner?: ContractRunner | null): ZSwapToken;
  waitForDeployment(): Promise<this>;

  interface: ZSwapTokenInterface;
  ...
  grantMintRole: TypedContractMethod<[to: AddressLike], [void], "nonpayable">;
