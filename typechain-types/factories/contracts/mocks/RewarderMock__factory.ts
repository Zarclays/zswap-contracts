...
import type {
  RewarderMock,
  RewarderMockInterface,
} from "../../../contracts/mocks/RewarderMock";
...
type RewarderMockConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: RewarderMockConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class RewarderMock__factory extends ContractFactory {
  constructor(...args: RewarderMockConstructorParams) {
    if (isSuperArgs(args)) {
      super(...args);
    } else {
  ...
  override connect(runner: ContractRunner | null): RewarderMock__factory {
    return super.connect(runner) as RewarderMock__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): RewarderMockInterface {
    return new Interface(_abi) as RewarderMockInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): RewarderMock {
    return new Contract(address, _abi, runner) as unknown as RewarderMock;
  }
}
