import { ADDRESS_ZERO, advanceBlock, advanceBlockTo, deploy, getBigNumber, prepare } from "./utilities/index.cts"
import { assert, expect } from "chai"

describe("MasterChefV2", function () {
  before(async function () {
    await prepare(this, ["MasterChef", "ZSwapToken", "ERC20Mock", "MasterChefV2", "RewarderMock", "RewarderBrokenMock"])
